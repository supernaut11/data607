...
3 + 4
x<-c(1,1,2)
# The line below produces an error. It is invalid syntax.
#3x
3*x
x^3
t(x)%*%x
...
# Load tidyverse before invoking functions from that library
library('tidyverse')
...
# Fun with mushrooms
# Update path to mushroom.csv file to match file system layout
